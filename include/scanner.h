...
typedef enum {
    ...
    TOKEN_STAR_STAR, TOKEN_BACKTICK, TOKEN_DEL,

    // Literals
    TOKEN_IDENTIFIER, TOKEN_STRING, TOKEN_INTERPOLATION, TOKEN_NUMBER,

    // Keywords
    TOKEN_AND, TOKEN_BREAK, TOKEN_BREAKALL, TOKEN_CLASS, TOKEN_ELSE, TOKEN_FALSE, TOKEN_FINAL, TOKEN_FUN, TOKEN_FOR, TOKEN_FOREACH, TOKEN_IF, TOKEN_NIL, TOKEN_OR,
    TOKEN_PRINT, TOKEN_RETURN, TOKEN_SUPER, TOKEN_THIS, TOKEN_TRUE, TOKEN_VAR, TOKEN_WHILE, TOKEN_CONTINUE, TOKEN_SWITCH, TOKEN_CASE, TOKEN_DEFAULT,
